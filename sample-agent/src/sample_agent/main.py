...
async def main() -> None:
    print(f"Sample agent starting — targeting API at {settings.api_base_url}")  # noqa: T201
    ...
    print("Agent not yet implemented — see halohttp.HttpPlugin for the client adapter.")  # noqa: T201
